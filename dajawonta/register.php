...
<?php include 'topbar.php'; ?>
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="registration-form">
                ...
                <div class="form-step" id="form-step-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="relative"><label for="birthday" class="block text-sm font-medium text-gray-700 mb-1">Birthday</label><div class="relative"><i class="fa-solid fa-cake-candles input-icon"></i>
                        <input type="date" id="birthday" name="birthday" value="<?php echo htmlspecialchars($birthday); ?>" class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent input-with-icon" required></div></div>
    ...
    // If PHP detected an error (like email taken), we set currentStep to 4
